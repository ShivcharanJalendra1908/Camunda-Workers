...
// // ========================================================================
// // 🔥 SINGLE MVP WORKFLOW EXECUTION HELPER
// // ========================================================================
...
// 	response, err := h.executeMVPWorkflow(c, "home_page", map[string]interface{}{
// 		"lang":         lang,
// 		"userId":       c.GetString("userId"),
// 		"pageType":     "home",
// 		"deviceType":   c.GetHeader("X-Device-Type"),
...
// 		variables["searchType"] = "keyword"
// 	}

// 	response, err := h.executeMVPWorkflow(c, "listing_page", variables)
// 	if err != nil {
// 		h.internalError(c, "Failed to fetch listing data", err)
// 		return
// 	}
...
// 	response, err := h.executeMVPWorkflow(c, "detail_page", map[string]interface{}{
// 		"slug":         slug,
// 		"userId":       c.GetString("userId"),
// 		"lang":         c.GetHeader("X-Lang"),
// 		"pageType":     "detail",
...
// 	response, err := h.executeMVPWorkflow(c, "search_franchises", map[string]interface{}{
// 		"filters":       string(filtersJSON),
// 		"userId":        c.GetString("userId"),
// 		"page":          filters.Page,
// 		"limit":         filters.Limit,
...
// 		"category":      filters.Category,
// 		"location":      filters.Location,
// 		"minInvest":     filters.MinInvestment,
// 		"maxInvest":     filters.MaxInvestment,
// 		"minSpace":      filters.MinSpace,
// 		"maxSpace":      filters.MaxSpace,
// 		"minRating":     filters.MinRating,
// 		"tags":          filters.Tags,

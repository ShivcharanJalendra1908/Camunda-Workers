...
// 	if input.FranchiseID != "" {
// 		if _, err := uuid.Parse(input.FranchiseID); err != nil {
// 			return appErrs.NewValidationError("franchiseId", "must be a valid UUID")
// 		}
// 	}
...
// // ✅ NEW: Validate query-specific requirements
// func (h *Handler) validateQueryTypeRequirements(input *Input) error {
// 	switch input.QueryType {
// 	case models.ESQueryTypeFranchiseBySlug:
// 		// Check for slug in multiple locations
...
// 			// CRITICAL: Block script fields
// 			if strings.Contains(lowerKey, "script") {
// 				return appErrs.NewNoSQLInjectionError(path+"."+key, "script")
// 			}
// 			if strings.Contains(lowerKey, "inline") {
// 				return appErrs.NewNoSQLInjectionError(path+"."+key, "inline")
// 			}
// 			if strings.Contains(lowerKey, "function") {
// 				return appErrs.NewNoSQLInjectionError(path+"."+key, "function")
// 			}
// 			if strings.Contains(lowerKey, "source") {
// 				return appErrs.NewNoSQLInjectionError(path+"."+key, "source")
// 			}
// 			if strings.Contains(lowerKey, "eval") {
// 				return appErrs.NewNoSQLInjectionError(path+"."+key, "eval")
// 			}
// 			if strings.Contains(lowerKey, "exec") {
// 				return appErrs.NewNoSQLInjectionError(path+"."+key, "exec")
// 			}
...
// // func (h *Handler) validatePagination(pagination Pagination) error {
// // 	if pagination.From < 0 || pagination.From > 10000 {
// // 		return appErrs.NewValidationError("pagination.from", "must be between 0 and 10000")
// // 	}
// // 	if pagination.Size < 1 || pagination.Size > 100 {
// // 		return appErrs.NewValidationError("pagination.size", "must be between 1 and 100")
// // 	}
// // 	return nil
// // }

// // ✅ FIXED - Apply defaults instead of erroring
// func (h *Handler) validatePagination(pagination *Pagination) error {
// 	// Apply defaults for missing values
// 	if pagination.Size <= 0 {
// 		pagination.Size = 10 // Default page size
...
// 		// ✅ Extract slug from filters if not already set
// 		if slug == "" {
// 			if filterSlug, ok := input.Filters["slug"].(string); ok {

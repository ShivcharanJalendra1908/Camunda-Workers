...
// 	// Parse input to determine operation type
// 	var baseInput BaseInput
// 	_, spanParse := otel.Tracer("worker-manager").Start(context.Background(), "franchise-postgres.parseInput")
// 	if err := json.Unmarshal([]byte(job.Variables), &baseInput); err != nil {
...
// 	_, spanExec := otel.Tracer("worker-manager").Start(ctx, "franchise-postgres.Execute")
// 	// Route to appropriate operation handler
// 	var result interface{}
// 	var err error

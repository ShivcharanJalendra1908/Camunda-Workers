...
// 	// Initialize Keycloak client
// 	keycloakClient, err := auth.NewKeycloakClient(&auth.KeycloakConfig{
// 		URL:          cfg.Auth.Keycloak.URL,
// 		Realm:        cfg.Auth.Keycloak.Realm,
...
// 	})
// 	if err != nil {
// 		log.Error("Failed to initialize Keycloak client", map[string]interface{}{
// 			"error": err.Error(),
// 		})
// 		os.Exit(1)
// 	}
...
// 	// Initialize Camunda client
// 	camundaClient, err := camunda.NewClient(&camunda.Config{
// 		GatewayAddress:     cfg.Camunda.GatewayAddress,
// 		UsePlainTextAuth:   cfg.Camunda.UsePlainTextAuth,
// 		KeepAlive:          time.Duration(cfg.Camunda.KeepAlive) * time.Second,
// 		RequestTimeout:     time.Duration(cfg.Camunda.RequestTimeout) * time.Millisecond,
// 		InsecureSkipVerify: cfg.Camunda.InsecureSkipVerify,
// 		CACertPath:         cfg.Camunda.CACertPath,
// 	})
// 	if err != nil {
// 		log.Error("Failed to initialize Camunda client", map[string]interface{}{
// 			"error": err.Error(),
...
// 	log.Info("Connected to Camunda/Zeebe", map[string]interface{}{
// 		"gateway": cfg.Camunda.GatewayAddress,
// 	})

// 	// Initialize PostgreSQL
// 	postgresDB, err := database.NewPostgresClient(cfg.Database.Postgres)
// 	if err != nil {
// 		log.Error("Failed to connect to PostgreSQL", map[string]interface{}{
// 			"error": err.Error(),
// 		})
...
// 	// Initialize Elasticsearch
// 	esClient, err := database.NewElasticsearchClient(cfg.Database.Elasticsearch)
// 	if err != nil {
// 		log.Error("Failed to connect to Elasticsearch", map[string]interface{}{
// 			"error": err.Error(),
// 		})
...
// 	// ============================================================================
// 	adminAPI := router.Group("/api/admin")
// 	adminAPI.Use(middleware.RateLimiter(cfg.API.RateLimit))
// 	adminAPI.Use(middleware.JWTAuth(cfg.Auth.JWT))
// 	adminAPI.Use(middleware.RequireRole("admin"))
// 	{
// 		// Workflow management
...
// 		// Check Elasticsearch
// 		if err := es.Ping(c.Request.Context()); err != nil {
// 			dependencies["elasticsearch"] = gin.H{"status": "unhealthy", "error": err.Error()}
// 			health["status"] = "degraded"
// 		} else {
// 			dependencies["elasticsearch"] = gin.H{"status": "healthy"}
...
// func printRoutesSummary(log logger.Logger, port int) {
// 	routes := []string{
// 		"\n📋 ═══════════════════════════════════════════════════════════════",
// 		"   LEMICI API GATEWAY - ROUTES ARCHITECTURE",
// 		"═══════════════════════════════════════════════════════════════\n",

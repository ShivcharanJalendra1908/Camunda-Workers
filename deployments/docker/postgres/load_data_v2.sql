...
\COPY industries(id, name, slug, icon_name, icon_url, image_url, color_hex, color_name, listing_title, listing_description, association_listing_description, master_franchise_listing_description, display_order, is_active, is_featured, meta_title, meta_description, created_at, updated_at) FROM '/tmp/industries.csv' WITH (FORMAT csv, HEADER true, NULL '');

\echo 'Loading categories.csv...'
\COPY categories(id, industry_id, name, slug, icon_name, icon_url, image_url, description, display_order, is_active, meta_title, meta_description, created_at, updated_at) FROM '/tmp/categories.csv' WITH (FORMAT csv, HEADER true, NULL '');

\echo 'Loading sub_categories.csv...'
\COPY sub_categories(id, category_id, name, slug, description, display_order, is_active, created_at, updated_at) FROM '/tmp/sub_categories.csv' WITH (FORMAT csv, HEADER true, NULL 'NULL');

\echo 'Loading listings.csv...'
\COPY listings(id, name, slug, short_description, description, founded_year, contact_email, website_url, logo_url_circle, logo_url_square, created_by, updated_by, created_at, updated_at, entity_type, status, verified, trusted_seller) FROM '/tmp/listings.csv' WITH (FORMAT csv, HEADER true, NULL '', FORCE_NULL(short_description, description, founded_year, contact_email, website_url, logo_url_circle, logo_url_square, updated_by));
...
\COPY associations(id, association_type, sector_represented, member_count, membership_fee_min, membership_fee_max) FROM '/tmp/associations.csv' WITH (FORMAT csv, HEADER true, NULL '', FORCE_NULL(sector_represented, member_count, membership_fee_min, membership_fee_max));
...
\COPY listing_stats(id, listing_id, rating, rating_count, follow_count, likes_count, view_count, save_count, share_count, enquiry_count, news_count, created_at, updated_at) FROM '/tmp/listing_stats.csv' WITH (FORMAT csv, HEADER true, NULL '', FORCE_NULL(rating));
...
\COPY franchise_business_overview(id, franchise_id, products, services, created_by, updated_by, created_at, updated_at) FROM '/tmp/franchise_business_overview.csv' WITH (FORMAT csv, HEADER true, NULL '', FORCE_NULL(updated_by));

\echo 'Loading franchise_investment_requirement.csv...'
\COPY franchise_investment_requirement(id, franchise_id, initial_investment_min, initial_investment_max, franchise_fee, royalty_percentage, marketing_fee_percentage, payback_min_months, payback_max_months, roi_min_percentage, roi_max_percentage, monthly_turnover_min, monthly_turnover_max, single_unit_cost_min, single_unit_cost_max, investment_includes, created_by, updated_by, created_at, updated_at, revenue_model) FROM '/tmp/franchise_investment_requirement.csv' WITH (FORMAT csv, HEADER true, NULL '', FORCE_NULL(initial_investment_min, initial_investment_max, franchise_fee, royalty_percentage, marketing_fee_percentage, payback_min_months, payback_max_months, roi_min_percentage, roi_max_percentage, monthly_turnover_min, monthly_turnover_max, single_unit_cost_min, single_unit_cost_max, investment_includes, revenue_model, updated_by));

\echo 'Loading franchise_operations.csv...'
\COPY franchise_operations(id, franchise_id, space_min_sqft, space_max_sqft, required_property_type, staff_required_min, staff_required_max, staff_breakdown, operating_hours, training_provided, training_details, computer_requirements, marketing_support, preferred_locations, qualification_required, supply_chain_support, quality_control, created_by, updated_by, created_at, updated_at, territory_details, development_schedule, support_training, legal_compliance) FROM '/tmp/franchise_operations.csv' WITH (FORMAT csv, HEADER true, NULL '', FORCE_NULL(required_property_type, operating_hours, training_details, computer_requirements, marketing_support, preferred_locations, qualification_required, updated_by));

\echo 'Loading category_questions.csv...'
\COPY category_questions(id, reference_id, entity_type, question, intent_tag, created_at) FROM '/tmp/category_questions.csv' WITH (FORMAT csv, HEADER true, NULL '');

\echo 'Loading industry_market_insights.csv...'
\COPY industry_market_insights(id, industry_id, industry_slug, entity_type, intent_tag, growth_rate_title, growth_rate_description, market_trend_title, market_trend_description, created_at, updated_at) FROM '/tmp/industry_market_insights.csv' WITH (FORMAT csv, HEADER true, NULL '');

        ...
        <div class="email-card">
            ...
            <div class="email-body">
                ...
                <div class="expiry-note">
                    <p style="margin: 0 0 10px 0;"><strong>Please note:</strong> This verification link will expire in ${(linkExpiration/60)?int} minutes. If you did not create a Lemici account, you can safely ignore this email.</p>
